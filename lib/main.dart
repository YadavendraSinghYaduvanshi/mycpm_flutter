...
import 'screen/image_data.dart';
import 'screen/main_page.dart';
import 'screen/human_resources.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return new MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        '/DataImage': (BuildContext context)=>new ImagePage(),
        '/MainPage': (BuildContext context)=>new MainPage(),
        '/HumanResources': (BuildContext context)=>new HumanResources(),
